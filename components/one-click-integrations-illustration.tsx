...
const OneClickIntegrationsIllustration: React.FC<OneClickIntegrationsIllustrationProps> = ({ className = "" }) => {
  ...
  const LogoBox: React.FC<{
    ...
    if (isGradientBg) {
      boxStyle.background = `linear-gradient(180deg, ${vars["--oci-gradient-light-gray-start"]} 0%, ${vars["--oci-gradient-light-gray-end"]} 100%)`
      boxStyle.boxShadow = `0px 1px 2px ${vars["--oci-shadow-color"]}`
